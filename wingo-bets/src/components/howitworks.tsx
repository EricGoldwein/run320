...
export default function HowItWorks() {
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold text-gray-900 mb-8">How $WINGO Works</h1>

      <div className="space-y-8">
        <section className="bg-white shadow-sm rounded-lg p-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">$WINGO Benefits</h2>
          <div className="space-y-4">
            <p className="text-gray-600">
              Holding $WINGO tokens comes with exclusive benefits and privileges:
            </p>
            <div className="bg-gray-50 p-4 rounded-md">
              <ul className="list-disc list-inside space-y-2 text-gray-600">
                ...
                <li>Recognition in the $WINGO Hall of Fame for top performers</li>
        ...
        <section className="bg-white shadow-sm rounded-lg p-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Mining $WINGO Tokens</h2>
          <div className="space-y-4">
            <p className="text-gray-600">
              $WINGO tokens are earned by completing Wingate track segments. Each 320m segment completed equals 1 $WINGO token.
            </p>
            <div className="bg-gray-50 p-4 rounded-md">
              <h3 className="font-medium text-gray-900 mb-2">Ways to Mine $WINGO:</h3>
              <ul className="list-disc list-inside space-y-2 text-gray-600">
        ...
        <section className="bg-white shadow-sm rounded-lg p-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Using $WINGO Tokens</h2>
          <div className="space-y-4">
            <p className="text-gray-600">
              $WINGO tokens can be used to place bets on various running events and challenges:
            </p>
            <div className="bg-gray-50 p-4 rounded-md">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 p-4 rounded-md">
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-600">
                ...
                <li>Set the bet amount in $WINGO tokens</li>
