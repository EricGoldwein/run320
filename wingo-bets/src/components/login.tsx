        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            <div className="text-sm">
              <Link to="/forgot-password" className="font-medium text-wingo-600 hover:text-wingo-500">
          ...
          <div className="text-sm text-center">
            ...
            <Link to="/register" className="font-medium text-wingo-600 hover:text-wingo-500">
              Register
            </Link>
          </div>
        </form>
