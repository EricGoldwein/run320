  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <img src="/wingowednesday.jpg" alt="WINGO Wednesday" className="w-full rounded-xl shadow-lg object-cover h-64 mb-6" />
          ...
          <div className="bg-green-50 border-l-4 border-green-400 p-4 rounded mb-6 text-center">
            <span className="font-semibold text-green-700">Next Session:</span> <span className="text-green-800">Check the <Link to="/events" className="text-wingo-600 hover:text-wingo-700 underline">Events</Link> page for the latest date!</span>
          </div>
        </div>
        <div className="space-y-8">
          <section className="bg-white rounded-xl shadow-sm p-8 border border-gray-100">
            ...
            <p className="text-lg text-gray-700 mb-2">
              Every other Wednesday, the 320 Track Club hosts a free, open session at the historic Wingate Track. Walk, run, sprint, or just hang out—everyone is welcome!
            </p>
            <ul className="list-disc list-inside text-gray-700 space-y-2">
              <li>Get a custom workout from <span className="font-semibold">Coach DAISY™</span></li>
              <li>Earn $WINGO for every 320m lap you complete</li>
          ...
          <section className="bg-white rounded-xl shadow-sm p-8 border border-gray-100">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-700">Nope! Walk, jog, sprint, or just cheer. Every lap counts the same.</p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-900">How do I earn $WINGO?</h3>
                <p className="text-gray-700">Complete a 320m lap and log it with Coach DAISY™. Each lap = 1 $WINGO. Sometimes there are bonus challenges!</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-gray-700">Ask Coach DAISY™ (she's the one with the hat) or any 320 Track Club member. Or <Link to="/faq" className="text-wingo-600 hover:text-wingo-700 underline">read the FAQ</Link>.</p>
              </div>
            </div>
          </section>
