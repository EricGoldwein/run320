  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="space-y-8">
        <div>
          <h2 className="text-xl font-semibold text-gray-900 mb-2">What is $WINGO?</h2>
          <p className="text-gray-600">
            $WINGO stands for <strong>Workout Independence Network Gains & Optimization</strong>. It is a digital token that can only be earned by completing the 320-meter segment at Wingate Track in Brooklyn. Each completed lap = 1 $WINGO. There is no other way to acquire it.
          </p>
        ...
        <div>
          ...
          <p className="text-gray-600">
            $WINGO was created as a response to the current state of running culture — where races cost $100+, sell out months in advance, and increasingly resemble subscription services.
          </p>
          <p className="text-gray-600 mt-2">
            This is not that. $WINGO is meant to be a leveling mechanism. Anyone who can complete a 320-meter loop — fast or slow — is eligible to participate. There is no registration fee. No merch. No sponsors. There is also no money. Only $WINGO.
          </p>
        </div>

        <div>
          <h2 className="text-xl font-semibold text-gray-900 mb-2">What can I do with $WINGO?</h2>
          <p className="text-gray-600">
          ...
          <p className="text-gray-600 mt-2">
            $WINGO is not transferable for cash or credit. It has no monetary value. 1 $WINGO is worth 1 $WINGO.
          </p>
        </div>

        <div>
          <h2 className="text-xl font-semibold text-gray-900 mb-2">How do I mine $WINGO?</h2>
          <p className="text-gray-600">
            You must complete the designated 320-meter segment at Wingate Track in Brooklyn. Each verified completion = 1 $WINGO.
          </p>
          <p className="text-gray-600 mt-2">
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Can I earn unlimited $WINGO?</h2>
          <p className="text-gray-600">
            Yes. There is no daily cap, monthly ceiling, or performance minimum.
          </p>
          <p className="text-gray-600 mt-2">
            Run the loop 10 times = 10 $WINGO.<br />
            Run it 100 times = 100 $WINGO.<br />
            Walk it once = 1 $WINGO.
          </p>
          <p className="text-gray-600 mt-2">
        ...
        <div>
          ...
          <p className="text-gray-600">
            Then it did not happen, and no $WINGO will be awarded. Exceptions may be granted in rare cases at the sole discretion of Coach DAISY™.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-600">
            Coach DAISY™ is an equine-powered AI coach that oversees the $WINGO economy. All appeals are reviewed by her. All final judgments are hers.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-600">
            ...
            1. Ensure you have at least 10 $WINGO tokens in your wallet
            2. Navigate to the registration page
            3. Connect your Strava account
            4. Pay the 10 $WINGO membership fee
        ...
        <div>
          ...
          <p className="text-gray-600">
            Voting power in the 320 Track Club is proportional to your $WINGO holdings. For example, if there are
            25 members with a total of 246 $WINGO tokens, and you hold 123 $WINGO, you would have 50% of the voting share.
