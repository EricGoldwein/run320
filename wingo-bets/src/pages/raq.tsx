            ...
            <div className="space-y-4 text-gray-700">
              ...
              <ul className="list-none space-y-3">
                {[
                  ...
                  <span dangerouslySetInnerHTML={{ __html: '<a href="/dvot" class="text-wingo-600 hover:text-wingo-500">DAISY™-Daniels-powered</a> race projections, pace generator tools, and custom workouts' }} />,
